        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceCurrency = table.Column<byte>(type: "tinyint", nullable: false),
                    BudgetCurrency = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    UserComment = table.Column<string>(type: "nvarchar(3000)", maxLength: 3000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CountryMovie_Country_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentLikeDislike", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentLikeDislike_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentLikeDislike_CommentId",
                table: "CommentLikeDislike",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentLikeDislike_UserId",
                table: "CommentLikeDislike",
                column: "UserId");
